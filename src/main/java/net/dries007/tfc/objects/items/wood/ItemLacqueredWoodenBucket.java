...
public class ItemLacqueredWoodenBucket extends ItemTFC
{
    private static final int CAPACITY = Fluid.BUCKET_VOLUME;

    public ItemLacqueredWoodenBucket()
    {
        setHasSubtypes(true);
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items)
    {
        if (isInCreativeTab(tab))
        {
            ...
            for (String fluidName : ConfigTFC.General.MISC.lacqueredWoodenBucketWhitelist)
            {
    ...
    {
        return new FluidWhitelistHandler(stack, CAPACITY, ConfigTFC.General.MISC.lacqueredWoodenBucketWhitelist);
    }
}
